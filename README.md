...
- You can use [Tech Debt Metrics](https://marketplace.visualstudio.com/items?itemName=Stepsize.tech-debt-tracker) as an alternative to `CodeMetrics` metric checker(But it is heavy).
